...
// Generic function type to print.
typedef void (*Print_t) (void const *data);

// Generic function type to compare to objects,.
typedef int (*Comp_t) (void const *a, void const *b);

// Generic function type to free allocated memory.
typedef void (*Free_t) (void *ptr);

// Generic function type to copy a given object.
typedef void *(*Copy_t) (void const *data);

// Generic function type to check whether a certain word is the last.
typedef bool (*Is_last_t) (void const *data);
...
// Type declaration for markov chain data structure, using all of the
// generic functions.
